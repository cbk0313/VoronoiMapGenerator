...
GenerateSetting::GenerateSetting(MapType _type, int _seed, signed int _nPoints, signed int _dimension, double _site_range, double _radius, double _lake_scale,
